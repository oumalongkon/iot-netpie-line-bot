...
$ACCESS_TOKEN = 'FXvQQzaWTW2a3/nBqe6qBXYDOhwCt67n8AMQQsNBRG33x/RyG2AfxCCGDGifGYEzoWILFRPIXPEKAJOEB4yQoybVgIvSY4UpXhVecfOGHeUy72mCRVEWgQtoGT0KFVBzSdLhyXU9T3rVIteCIc7wLAdB04t89/1O/w1cDnyilFU='; // Access Token ค่าที่เราสร้างขึ้น
  ...
  if ( $event['type'] == 'message' ) 
  {
   ...
   if( $event['message']['type'] == 'text' )
   {
		$text = $event['message']['text'];
		   ...
		   $reply_message = 'รายงานสถานการณ์ โควิด-19 มีผู้ป่วยสะสม '. $obj->{'Confirmed'} .' คน '.'ผู้เสียชีวิต '. $obj->{'Deaths'} .' คน ' . 'รักษาหาย '. $obj->{'Recovered'} .' คน' ;
	        }	
